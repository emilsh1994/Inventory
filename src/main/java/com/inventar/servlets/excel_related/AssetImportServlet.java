...
public class AssetImportServlet extends HttpServlet {
            ...
            try {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (!item.isFormField()) {
                        ...
                        ExcelUtils.getInstance().importAssetsFromExcel(book);
                    }
                }
    ...
    private String getTemplate() {
        String html = "<html>" +
                "<form action=\"/assetImport\" enctype=\"multipart/form-data\" method=\"post\">" +
